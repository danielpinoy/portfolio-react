    ...
    return (
        <div>
            <body>
                ...
                <section id="about" ref={aboutRef} className={`hidden ${aboutView ? "show" : ""}`}>
                        ...
                        <div className="about-details-container">
                            ...
                            <div className="text-container">
                                <p>
                                    ...
                                    frameworks. With a background in frontend development and cloud
                                    computing.
                                    <br />
                                    <br />
                    ...
                    <div className="experience-details-container">
                        <div className="projects-about-container">
                            ...
                            <div
                                ...
                                <h2 className="experience-sub-title project-title">MeetUp App</h2>
                                <div className="btn-container">
                                    <button
                                        className="btn btn-color-2 project-btn"
                            ...
                            <div
                                ...
                                <h2 className="experience-sub-title project-title">RetroFlix</h2>
                                <div className="btn-container">
